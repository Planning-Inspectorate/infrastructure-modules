...
* # vm-linux
* 
* An example deployment of a Linux based VM with additional data disks
* 
...
module "vm" {
  ...
  disk_count_linux       = 4
  disk_sizes_linux       = [100, 100, 100, 100]
  disk_skus_linux        = ["Premium_LRS", "Premium_LRS", "Premium_LRS", "Premium_LRS"]
  disk_caching_linux     = ["ReadWrite", "ReadWrite", "ReadWrite", "ReadWrite"]
}