...
func TestExampleVmWindowsDisks(t *testing.T) {
	...
	// varFileName := "example_vm_windows_disks"
	varFileName := os.Getenv("VARFILE")
	...
	terraformOptions := &terraform.Options{
		...
		VarFiles: []string{"environments/" + varFileName + ".tfvars"},
