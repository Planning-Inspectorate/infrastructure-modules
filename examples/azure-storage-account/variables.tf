...
variable "directory_type" {
  type        = string
  description = "Defines whether the Storage Account will be joined to the Hiscox.com AD in order to provide identity based auth / RBAC to File Shares"
...
variable "storage_sid" {
  type        = string
  description = "SID of a pre-staged hiscox.com AD computer object for the storage account. Required if directory_type is set to ad-joined."
  default     = null
}
